    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Population)
                ...
                %% train a random forest for each objective
                Model = cell(1,Problem.M);
                Feature = cell(1,Problem.M);
                for i = 1 : Problem.M
                        [Model{i},Feature{i}] = ForestTrain(PopDec,GLoc(:,i),Ktree,1,0.8);
                end 
                ...
                %% optimization
                choose = EnvironmentalSelectionNSGA2(Population,Problem.N); % select N solutions from DB as the initial population, here we use the environmental selection in NSGA2
                ...
                while w < wmax
                    ...
                    for i = 1 :Problem.N
                        for j = 1 : Problem.M
                            OffGLoc(i,j) = ForestPredict(Model{j},OffDec(i,:),Ktree,1,Feature{j});
                        end
                    end
